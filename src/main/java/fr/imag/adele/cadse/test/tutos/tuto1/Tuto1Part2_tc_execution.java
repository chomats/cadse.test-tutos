...
public class Tuto1Part2_tc_execution extends TutoTestCase {
	...
	public void test_App() throws Exception {
		...
		GTCadseFactory.findCadseWorkbenchPart(shell).findField(CadseGCST.ITEM_at_NAME_).typeText("Hello2App");
		shell.close();
		...
		GTCadseFactory.findCadseWorkbenchPart(shell).findField(CadseGCST.ITEM_at_NAME_).typeText("Hello2Servlet");
